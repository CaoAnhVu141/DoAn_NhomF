...
Route::get('attribute',[AdminAttributeController::class,'showIndexAattribute'])->name('showattribute');
...
Route::get('oders-detail',[AdminOdersController::class,'showDetailIndexOder'])->name('showoderdetail');
