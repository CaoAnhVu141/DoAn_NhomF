                        ...
                        <div class="box-header with-border">
                          ...
                          <div class="box-body">
                            ...
                            <div class="form-group col-sm-6" >
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-dollar"></i></span>
                                        <input type="number" name="pro_price" class="form-control" value="">
                            ...
                            <div class="form-group">
                                ...
                                <select name="pro_category_id" class="form-control js-check-type" data-url="">
                                    {{-- @todo --}}
                                    {{-- @if (isset($category))
                                            ...
                                            <div class="col-sm-4">
                                                @foreach ($attribute as $item)
                                                    <div class="form-group">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" name="attribute_{{ $item->id }}" value="{{ $item->id }}"> {{ $item->name }}
                                                            </label>
                                                        </div>
                                                    </div>
                                                @endforeach
                      ...
                      <div class="box box-success">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" value="" name="content" rows="3" placeholder="Enter ...">{{ old('pro_content') }}</textarea>
                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="number" name="pro_number" value="" class="form-control" placeholder="0">
