                        ...
                        <div class="box-header with-border">
                          ...
                          <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description" rows="3" placeholder="Enter ...">{{ old('pro_description') }}</textarea>
                            </div>
                                            ...
                                            <div class="col-sm-4">
                                                @foreach ($attribute as $item)
                                                    <div class="form-group">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" name="attribute[]" value="{{ $item->id }}"> {{ $item->name }}
                                                            </label>
                                                        </div>
                                                    </div>
                                                @endforeach
                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="number" name="quality" class="form-control" placeholder="0">
                            </div>
                        </div>
                    </div>
                </div>
